...
public class ProdutoLojaAdapter extends BaseAdapter {

    private final ArrayList<Produto> produtos;
    private final Activity act;

    public ProdutoLojaAdapter(ArrayList<Produto> produtos, Activity act){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view = act.getLayoutInflater().inflate(R.layout.item_loja, parent, false);
        ...
        //vendedor.setText(produto.getVendedor());
