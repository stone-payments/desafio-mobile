...
public class CarrinhoAdapter extends BaseAdapter {
    ...
    public CarrinhoAdapter(Context context, List<Produto> produtoLits) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            TextView t = convertView.findViewById(R.id.produto_add_carrinho);
            t.setBackgroundResource(R.drawable.selector_remove_carrinho);
            t.setText(R.string.remove_carrinho);
